                ...
                <div className="container relative z-10 px-6 md:px-10">
                    <div className="max-w-[1400px] mx-auto">
                        <motion.div initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }} className="relative">
                            <h1 className="text-[14vw] md:text-[11vw] font-black leading-[0.8] tracking-tighter uppercase italic text-black dark:text-white">
                                Aura<br /><span className="ml-[10vw] text-outline text-black dark:text-white">Studio</span>
                            </h1>
            ...
            <section className="py-32 overflow-hidden bg-stone-50/50 dark:bg-neutral-900/20 backdrop-blur-3xl border-y border-stone-100 dark:border-neutral-800">
                <div className="max-w-[1400px] mx-auto px-6 md:px-10 mb-24">
                    <div className="flex flex-col md:flex-row items-end justify-between gap-8">
                        ...
                        <p className="max-w-xs text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em] leading-relaxed text-right md:mb-4">
                            Curated selections from the AURA Studio. Each piece is a testament to architectural integrity.
                        </p>
                    </div>
                </div>

                <div className="flex overflow-x-auto no-scrollbar gap-10 pb-10 snap-x snap-mandatory px-6 md:px-[10vw]">
                ...
                <div className="flex flex-col items-center justify-center mb-32 space-y-10">
                    ...
                    >
                        ...
                        <input
                            ...
                            className="w-full pl-16 pr-16 py-6 bg-white/70 dark:bg-neutral-900/70 backdrop-blur-2xl border border-stone-100 dark:border-neutral-800 rounded-[2rem] focus:outline-none focus:ring-0 focus:border-black dark:focus:border-white transition-all font-black text-sm uppercase tracking-widest shadow-2xl shadow-stone-200/50 dark:shadow-none"
                        />
                        {searchTerm && (
                            <button
